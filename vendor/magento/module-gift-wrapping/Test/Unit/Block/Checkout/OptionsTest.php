...
class OptionsTest extends \PHPUnit\Framework\TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->checkoutCartFactoryMock = $this->getMockBuilder(\Magento\Checkout\Model\CartFactory::class)
            ...
            ->getMock();
        $this->taxClassfactoryMock = $this->createPartialMock(\Magento\Tax\Api\Data\TaxClassKeyInterfaceFactory::class, ['create']);
    ...
    public function testGetCheckoutTypeVariableException()
    {
        ...
        $this->expectException('InvalidArgumentException', 'Invalid level: ' . $level);
