...
class GiftcardTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->_store = $this->createPartialMock(\Magento\Store\Model\Store::class, ['getCurrentCurrencyRate', '__sleep', '__wakeup']);
    ...
    protected function _preConditions()
    {
        ...
        $itemFactoryMock = $this->createPartialMock(\Magento\Catalog\Model\Product\Configuration\Item\OptionFactory::class, ['create']);
        $stockItemFactoryMock = $this->createPartialMock(\Magento\CatalogInventory\Api\Data\StockItemInterfaceFactory::class, ['create']);
