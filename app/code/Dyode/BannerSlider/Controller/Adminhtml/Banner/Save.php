<?php
namespace Dyode\BannerSlider\Controller\Adminhtml\Banner;

use Magento\Framework\App\Filesystem\DirectoryList;

/**
 * Overrides Save banner action.
 * @category Dyode
...
class Save extends \Magestore\Bannerslider\Controller\Adminhtml\Banner\Save
{
    ...
    public function execute()
    {
        ...
        if ($data = $this->getRequest()->getPostValue()) {
            ...
            $bannerStoreIds = $data['bannerstore_id'];

            foreach ($bannerStoreIds as $storeId) {
                $data['bannerstore_id'] = $storeId;
                $model->setData($data)
