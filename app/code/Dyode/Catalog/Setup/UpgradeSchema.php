...
class UpgradeSchema implements UpgradeSchemaInterface
{
    ...
    public function upgrade(
        ...
        if (version_compare($context->getVersion(), "1.0.5", "<")) {
            $this->upgradeSchemaOneZeroFive($setup);
        }
    }
    ...
    public function upgradeSchemaOneZeroFive(SchemaSetupInterface $setup)
    {
        $setup->startSetup();
        ...
        $connection->dropColumn( $orderItemTableName, 'warranty_order_item_id', $schemaName = null);
