...
/**
 * Class Sold out related products
 *
 * @api
 *
 ...
 * @since 101.0.0
 */
class SoldoutProduct extends AbstractModifier
{
    const DATA_SCOPE = '';
    const DATA_SCOPE_SOLD = 'soldout';
    const SOLD = 'soldout';

    /**
     * @var string
     */
    private static $previousGroup = 'fbt';
    ...
    public function modifyMeta(array $meta)
    {
        ...
        $meta = array_replace_recursive(
            ...
            [
                static::SOLD => [
                    'children'  => [
                        static::SOLD => $this->getSoldoutFieldset(),
                    ],
                    'arguments' => [
                        'data' => [
                            'config' => [
                                'label'         => __('Soldout Related Products'),
                                'collapsible'   => true,
     ...
     * Prepare data column
     *
     * @param \Magento\Catalog\Api\Data\ProductInterface     $linkedProduct
     * @param \Magento\Catalog\Api\Data\ProductLinkInterface $linkItem
     * @return array
    ...
    {
        return [
            static::DATA_SCOPE_SOLD,
        ];
    }

    /**
     * Prepares config for the Soldout products fieldset
     *
     * @return array
     */
    protected function getSoldoutFieldset()
    {
        $content = 'Products to show when the parent product is sold out';
        $content = __($content);
        ...
        return [
            'children'  => [
                'button_set' => $this->getButtonSet(
                    $content,
                    __('Add Soldout Related Products'),
                    static::SOLD
                ),
                ...
                static::SOLD  => $this->getGrid(static::SOLD),
            ],
            'arguments' => [
                'data' => [
                    'config' => [
    ...
    {
        $modalTarget = 'product_form.product_form.' . static::SOLD . '.' . static::SOLD . '.modal';
                        ...
                        'data' => [
                            'config' => [
                                ...
                                'actions'       => [
                                    ...
                                    [
                                        'targetName' => $modalTarget . '.' . static::SOLD . '_product_listing',
                                        'actionName' => 'render',
                                    ],
                                ],
                                'title'         => $buttonTitle,
