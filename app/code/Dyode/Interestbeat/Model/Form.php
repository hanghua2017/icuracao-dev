...
class Form extends \Magento\Framework\Model\AbstractModel
{
     ...
     * @var string
     */
    const CACHE_TAG = 'dyode_interestbeat_form';
     ...
     * @var string
     */
    protected $_cacheTag = 'dyode_interestbeat_form';
     ...
     * @var string
     */
    protected $_eventPrefix = 'dyode_interestbeat_form';
    ...
    {
        $this->_init('Dyode\Interestbeat\Model\ResourceModel\Form');
    }
