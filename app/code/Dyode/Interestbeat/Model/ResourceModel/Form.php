 ...
 */
namespace Dyode\Interestbeat\Model\ResourceModel;
...
class Form extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('dyode_interestbeat_form', 'form_id');
    }
     ...
     *
     * @param \Magento\Framework\Model\AbstractModel|\Dyode\Interestbeat\Model\Form $object
     * @return $this
     */
