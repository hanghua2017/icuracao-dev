...
class Columns extends UiColumns
{
    ...
    public function prepare()
    {
        ...
        foreach ($allColumns as $identifier) {
            ...
            if (in_array($identifier, $this->uiContext->getReport()->getAvailableFilters())
                && !in_array($identifier, $this->uiContext->getReport()->getDefaultColumns())
                && !in_array($identifier, $this->uiContext->getReport()->getColumns())
                && !in_array($identifier, $this->uiContext->getReport()->getDimensions())
            ) {
                $isFilterOnly = true;
            }
