    ...
    implements \Mirasvit\Rma\Api\Data\RmaInterface, IdentityInterface
{
    ...
    {
        return $this->rmaData->rmaSearchManagement->hasRmaResolution($this, $resolutionId);
    }
    ...
    {
        return $this->rmaData->rmaSearchManagement->hasRmaCondition($this, $conditionId);
    }
    ...
    {
        return $this->rmaData->rmaSearchManagement->hasRmaResolution($this, $reasonId);
    }
