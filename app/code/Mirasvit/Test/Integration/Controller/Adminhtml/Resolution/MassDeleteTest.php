...
class MassDeleteTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/rma/resolution/massdelete';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Rma\Controller\Adminhtml\Resolution\MassDelete::execute
     */
    public function testMassDeleteAction()
    {
        $this->dispatch('backend/rma/resolution/massdelete');
