...
class MassChangeTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/rma/resolution/masschange';
        parent::setUp();
    }

    /**
     * @covers  Mirasvit\Rma\Controller\Adminhtml\Resolution\MassChange::execute
     */
    public function testMassChangeAction()
    {
        $this->dispatch('backend/rma/resolution/masschange');
