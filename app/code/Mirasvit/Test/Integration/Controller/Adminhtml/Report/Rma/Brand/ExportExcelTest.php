...
class ExportExcelTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/rma/brand/exportexcel';
        parent::setUp();
        $this->markTestSkipped();
    }

    /**
     * @covers  Mirasvit\Rma\Controller\Adminhtml\Report\Rma\Brand\ExportExcel::execute
     */
    public function testExportExcelAction()
    {
        $this->markTestSkipped();
        $this->dispatch('backend/rma/brand/exportexcel');
