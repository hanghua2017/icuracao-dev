...
class ExportCsvTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function setUp()
    {
        ...
        $this->uri = 'backend/rma/product/exportcsv';
        parent::setUp();
        $this->markTestSkipped();
    }

    /**
     * @covers  Mirasvit\Rma\Controller\Adminhtml\Report\Rma\Product\ExportCsv::execute
     */
    public function testExportCsvAction()
    {
        $this->dispatch('backend/rma/product/exportcsv');
