...
/**
 * @covers \Mirasvit\Rma\Model\Condition
...
class ConditionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->resourceMock = $this->getMock(
            '\Mirasvit\Rma\Model\ResourceModel\Condition',
            [],
            [],
            '',
            false
        ...
        $this->resourceCollectionMock = $this->getMock(
            '\Mirasvit\Rma\Model\ResourceModel\Condition\Collection',
            [],
            [],
            '',
            false
        ...
        $this->conditionModel = $this->objectManager->getObject(
    ...
    {
        $this->assertEquals($this->conditionModel, $this->conditionModel);
    }
}
