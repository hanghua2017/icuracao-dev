...
/**
 * @covers \Mirasvit\Rma\Model\Reason
...
class ReasonTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->resourceMock = $this->getMock(
            '\Mirasvit\Rma\Model\ResourceModel\Reason',
            [],
            [],
            '',
            false
        ...
        $this->resourceCollectionMock = $this->getMock(
            '\Mirasvit\Rma\Model\ResourceModel\Reason\Collection',
            [],
            [],
            '',
            false
        ...
        $this->reasonModel = $this->objectManager->getObject(
    ...
    {
        $this->assertEquals($this->reasonModel, $this->reasonModel);
    }
}
