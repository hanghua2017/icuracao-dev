...
namespace Mirasvit\Rma\Test\Unit\Controller\Adminhtml\Resolution;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManager;

/**
 * @covers \Mirasvit\Rma\Controller\Adminhtml\Resolution\MassChange
...
class MassChangeTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Rma\Controller\Adminhtml\Resolution\MassChange|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $resolutionController;
    ...
    public function setUp()
    {
        ...
        $this->resolutionController = $this->objectManager->getObject(
            '\Mirasvit\Rma\Controller\Adminhtml\Resolution\MassChange',
            [
    ...
    {
        $this->assertEquals($this->resolutionController, $this->resolutionController);
    }
}
