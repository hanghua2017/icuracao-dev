...
namespace Mirasvit\Rma\Test\Unit\Controller\Adminhtml\Condition;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManager;

/**
 * @covers \Mirasvit\Rma\Controller\Adminhtml\Condition\MassDelete
...
class MassDeleteTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Rma\Controller\Adminhtml\Condition\MassDelete|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $conditionController;
    ...
    public function setUp()
    {
        ...
        $this->conditionController = $this->objectManager->getObject(
            '\Mirasvit\Rma\Controller\Adminhtml\Condition\MassDelete',
            [
    ...
    {
        $this->assertEquals($this->conditionController, $this->conditionController);
    }
}
