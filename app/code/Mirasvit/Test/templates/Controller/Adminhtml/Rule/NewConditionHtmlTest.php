...
namespace Mirasvit\Rma\Test\Unit\Controller\Adminhtml\Rule;

use Magento\Framework\TestFramework\Unit\Helper\ObjectManager as ObjectManager;

/**
 * @covers \Mirasvit\Rma\Controller\Adminhtml\Rule\NewConditionHtml
...
class NewConditionHtmlTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Mirasvit\Rma\Controller\Adminhtml\Rule\NewConditionHtml|\PHPUnit_Framework_MockObject_MockObject
     */
    protected $ruleController;

    /**
     * @var \Mirasvit\Rma\Model\RuleFactory|\PHPUnit_Framework_MockObject_MockObject
     */
    ...
    public function setUp()
    {
        $this->ruleFactoryMock = $this->getMock(
            '\Mirasvit\Rma\Model\RuleFactory',
            ['create'],
            [],
            '',
            false
        ...
        $this->ruleController = $this->objectManager->getObject(
            '\Mirasvit\Rma\Controller\Adminhtml\Rule\NewConditionHtml',
            [
