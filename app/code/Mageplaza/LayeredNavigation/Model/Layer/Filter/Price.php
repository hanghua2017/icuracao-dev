...
// edited  $from * $this->getCurrencyRate();
     $value =$this->getCurrencyRate();//. '-' . $to * $this->getCurrencyRate();//. $this->dataProvider->getAdditionalRequestData();
// it return price interval - 200-300[non numeric value]
