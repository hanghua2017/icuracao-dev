 ...
 * Last Modified: 2018-10-01T13:39:52+00:00
    ...
    protected function exportProductData($product, &$returnArray)
    {
        ...
        if ($this->fieldLoadingRequired('xtento_mapped_category')) {
            ...
            foreach ($categoryIds as $categoryId) {
                if (isset(self::$categoryMapping[$categoryId])) {
                    $mappedCategory = self::$categoryMapping[$categoryId];
                    break;
                }
            }
        ...
        if ($this->fieldLoadingRequired('custom_options') && !$exportAllFields) {
            ...
            $product->clearInstance()->setStoreId($this->getStoreId())->load($product->getId());
