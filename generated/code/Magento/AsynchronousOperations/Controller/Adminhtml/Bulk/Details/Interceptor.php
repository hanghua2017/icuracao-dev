...
class Interceptor extends \Magento\AsynchronousOperations\Controller\Adminhtml\Bulk\Details implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function __construct(\Magento\Backend\App\Action\Context $context, \Magento\Framework\View\Result\PageFactory $resultPageFactory, \Magento\AsynchronousOperations\Model\AccessValidator $accessValidator)
    {
        $this->___init();
        parent::__construct($context, $resultPageFactory, $accessValidator);
    }
